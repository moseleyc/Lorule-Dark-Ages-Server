namespace Darkages.Network.ClientFormats
{
    ...
    public class ClientFormat29 { }
    public class ClientFormat2A { }
    ...
    public class ClientFormat3F { } // (Map Click)
