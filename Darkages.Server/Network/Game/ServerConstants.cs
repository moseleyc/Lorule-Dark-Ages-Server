...
namespace Darkages.Network.Game
{
    public class ServerConstants
    {
        ...
        {
            return StorageManager.Save<ServerConstants>(this)
                ?? string.Empty;
        }
        ...
        [JsonProperty]
        public  string ChantSuffix = "*";

        [JsonProperty]
        public  string GroupRequestDeclinedMsg = "noname does not wish to join your group.";

        [JsonProperty]
        public  string GroupedAlreadyMsg = "noname is already in a group.";

        [JsonProperty]
        public  string UserDroppedGoldMsg = "noname has dropped some money nearby.";

        [JsonProperty]
        public  string YouDroppedGoldMsg = "you dropped some gold.";

        [JsonProperty]
        public  string NotEnoughGoldToDropMsg = "You wish you had that much.";

        [JsonProperty]
        public  string CantDropItemMsg = "You can't drop that.";

        [JsonProperty]
        public  string CantDoThat = "You can't do that.";
        ...
        [JsonProperty]
        public  string ServerTablePath = "server.tbl";

        [JsonProperty]
        public  int SERVER_PORT = 2615;

        [JsonProperty]
        public  string SERVER_TITLE = "Darkages Server : 7.18";

        [JsonProperty]
        public  int ConnectionCapacity = 2048;

        [JsonProperty]
        public  int LOGIN_PORT = 2610;

        [JsonProperty]
        public  int ERRORCAP = 5;
        ...
        [JsonProperty]
        public  string StrAddedMessage = "You become stronger.";

        [JsonProperty]
        public  string IntAddedMessage = "Your mind expands.";

        [JsonProperty]
        public  string WisAddedMessage = "Your will increases.";

        [JsonProperty]
        public  string ConAddedMessage = "You become more fit.";

        [JsonProperty]
        public  string DexAddedMessage = "You feel more flexible.";
        ...
        [JsonProperty]
        public  int VeryNearByProximity = 5;

        [JsonProperty]
        public  double WithinRangeProximity = 13.0;

        [JsonProperty]
        public  bool RecvWaitAll = true;

        [JsonProperty]
        public  bool RecvUseTaskMethod = true;

        [JsonProperty]
        public  bool SendClientPacketsAsAsync = true;

        [JsonProperty]
        public  int PacketOverflowLimit = 1024;

        [JsonProperty]
        public  int ClientPacketSendErrorLimit = 3;

        [JsonProperty]
        public  bool TransFormAsParallel = true;

        [JsonProperty]
        public bool DebugMode = false;

        [JsonProperty]
        public double ObjectCacheInterval = 10;
        ...
        /// </summary>
        [JsonProperty]
        public bool CacheObjects = true;

        [JsonProperty]
        public bool UseFastSqrtMethod = false;

        [JsonProperty]
        public bool LimitWalkingWhenRefreshing = false;

        [JsonProperty]
        public bool CancelCastingWhenWalking = true;

        [JsonProperty]
        public bool RefreshOnWalkCollision = true;

        [JsonProperty]
        public bool DontTurnDuringRefresh = false;

        [JsonProperty]
        public int AutoLootPickupDistance = 2;

        [JsonProperty]
        public int ClickLootDistance = 3;

        [JsonProperty]
        public byte BaseStatAttribute = 3;

        [JsonProperty]
        public double MonsterDamageFactor = 2.58;

        [JsonProperty]
        public int MonsterDamageMultipler = 10;

        [JsonProperty]
        public double MapUpdateInterval = 1000;

        [JsonProperty]
        public int MaxCarryGold = 100000000;

        [JsonProperty]
        public double ObjectGarbageCollectorInterval = 1000;

        [JsonProperty]
        public double DropDecayInSeconds = 30;

        [JsonProperty]
        public string DoesNotFitMessage = "That does not fit you.";

        [JsonProperty]
        public string CantEquipThatMessage = "You can't use that.";

        [JsonProperty]
        public int MonsterSkillSuccessRate = 3;
